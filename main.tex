...
\newcommand{\DHmic}{\(\Delta H^0_{\mathrm{mic}}\)}
\newcommand{\DHwlm}{\(\Delta H^0_{\mathrm{WLM}}\)}
...
% todo: pensar em trocar o tamanho de várias figuras por isto.
% se for figure, height=\figheight,
% se for subfigure, somente \figheight
% ---
