...
%		TODO
	...
	\chapter{Reologia oscilatória}
		...
		\noindent onde \(y_i\) é o i-ésimo ponto da curva, \(I\) é o número total de pontos, \(\hat{y}\) é a média dos valores de \(y\) (G' ou G''), \(\hat{y}_i\) é o i-ésimo valor previsto pelo modelo e \(p\) é o número de parâmetros do modelo (p.e. modelo de Maxwell possui \(G_0\), \(\tau_r\), \(p=2\)).
		...
		\begin{figure}[h]
			...
			\caption{Ajustes de Maxwell para as curvas da figura \ref{fig:oscilatorio_agua}}
			\label{fig:oscilatorio_agua_maxwell}
		\end{figure}
	
		Na a figura \ref{fig:oscilatorio_agua_35}, o ponto de cruzamento visual e o calculado divergem significantemente. Além disso, é observado um aumento de G'' em altas frequências não previsto pelo modelo, e G' também possui uma divergência da planaridade. Isso indica que não há somente um tempo de relaxação nesse sistema, e que outros modos de relaxação se tornam mais evidentes à medida que a frequência aumenta. O mesmo pode ser observado, mas em menor escala, para a curva \ref{fig:oscilatorio_agua_60}. % todo: comparar com o artigo do Hoffmann
		
		As outras amostras seguiram consideravelmente bem o modelo de Maxwell, com valores de \(R^2\) próximos à unidade. Além disso, observa-se que não há uma diferença significativa entre \(R^2\) e \(R\mathrm{'}^2\).
		
		O mesmo procedimento foi seguido para os outros modelos. Os ajustes não serão mostrados por brevidade. Os resultados dos ajustes se encontram nas tabelas X, Y, Z e nas figuras X, Y, Z.
		
		\begin{table}[h]
        \IBGEtab{%
			\caption{Valor do parâmetro \(G_0\) em Pa de todos os ajustes}
			\label{tab:g0_agua}
		}%
		{%
			\begin{tabular}{c c c c c c}
				...
				35 & 30,818 \(\pm\) 0,459 & 30,804 \(\pm\) 0,431 & 30,810 \(\pm\) 0,431 & 26,797 \(\pm\)  0,304 & 7,277 \(\pm\) 0,366 \\
				60 & 51,507 \(\pm\) 0,280 & 51,493 \(\pm\) 0,279 & 51,499 \(\pm\) 0,279 & 31,865 \(\pm\)  1,679 & 20,644\(\pm\)  1,662 \\
				72 & 39,954 \(\pm\) 0,146 & 39,922 \(\pm\) 0,134 & 39,938 \(\pm\) 0,134 & 35,872 \(\pm\)  0,928 & 4,596 \(\pm\) 0,909 \\
				100 & 52,310 \(\pm\) 0,137 & 52,086 \(\pm\) 0,118 & 52,196 \(\pm\) 0,113 & 3,585  \(\pm\) 0,465 & 49,705 \(\pm\) 0,514 \\
				189 & 49,702 \(\pm\) 0,263 & 49,630 \(\pm\) 0,253 & 49,665 \(\pm\) 0,252 & 48,280 \(\pm\)  0,297 & 3,733 \(\pm\) 0,398 \\
				260 & 51,589 \(\pm\) 0,331 & 51,511 \(\pm\) 0,314 & 51,549 \(\pm\) 0,313 & 49,691 \(\pm\)  1,051 & 2,918 \(\pm\) 1,007 \\ 
				365 & 49,795 \(\pm\) 0,211 & 49,642 \(\pm\) 0,168 & 49,716 \(\pm\) 0,166 & 46,964 \(\pm\)  0,314 & 4,181 \(\pm\) 0,291 \\
				\bottomrule
			\end{tabular}
		}{}
		\end{table}  % todo: colocar os erros aqui
