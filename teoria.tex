...
%				\end{subfigure}
	...
	\noindent onde \(\nu_e\) é a frequência da primeira absorção eletrônica dos componentes das fases, geralmente \(3 \times 10^{15}\) s\menosUm.
	
	% Falar sobre as interações sem considerar a aditividade, achar a cte de Hamaker.
	% Depois voltar para o prob. da aditividade, descrever direito o que isso significa.
