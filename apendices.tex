...
\section{Resumo do modelo} \index{apêndices!modelos} \index{SAXS!modelagem!micelas gigantes}
...
\begin{equation}
	F_\mathrm{wc} \approx 
		\begin{cases}
			F_{\mathrm{chain}_\mathrm{ExV}}		& q\mathrm{\> baixo}  \\
			F_\mathrm{rod}						& q\mathrm{\> alto}
		\end{cases}
...
O programa SUPERSAXS foi desenvolvido em FORTRAN77 por Jan Skov Pedersen e Cristiano Oliveira, na Universidade de Århus, Dinamarca, para o ajuste não linear com base no método dos mínimos quadrados. A operação do programa é totalmente baseada em comandos de texto. Este documento visa guiar um novo usuário a como utilizar o programa e alertá-lo para todos os eventuais problemas que possam aparecer. O código-fonte do programa está disponível para outras pessoas que desejam utilizá-lo e modificá-lo, mas não pode ser publicado. Compiladores de Fortran 95, como o \texttt{gfortran} conseguem compilar o código.
...
\chapter{Tabela de conversão das concentrações dos aditivos}
\label{sec:tabelas_conversao}

Neste trabalho, utilizou-se primariamente a concentração em fração mássica dos aditivos. Neste apêndice, será informada algumas conversões de fração mássica para outras grandezas de concentração.

\begin{table}[h]
	\IBGEtab%
	{\caption{Propriedades de glicerina em água, a 20°C. Fração mássica/\%, densidade \(\rho\)/g.cm\(^{-3}\), molaridade \(c\)/\(mol.L^{-1}\), molalidade \(m\)/\(mol.kg^{-1}\), fração molar/\%, proporções molares, e proporção molar de hidroxilas. Densidades obtidas de \citeauthor{Lide2003}. A massa molar da glicerina é 92,09382 g.mol\menosUm }
		\label{tab:conversoes_glicerina}}%
	{
		\centering
		\begin{tabular}{c c c c c c c c}
			\toprule
			\% m/m & \(\rho\) & \(c\)  & \(m\)  & Fração molar & \(\dfrac{n_\mathrm{glincerina}}{n_\mathrm{água}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{glincerina}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{OH}}\) \\ \midrule
			  1    & 1,0005   & 0,1086 & 0,1097 & 0,1972       & 0,002              & 506,1              & 168,7       \\
			  2    & 1,0028   & 0,2178 & 0,2216 & 0,3976       & 0,004              & 250,5              & 83,50       \\
			  3    & 1,0051   & 0,3274 & 0,3358 & 0,6014       & 0,006              & 165,3              & 55,10       \\
			  4    & 1,0074   & 0,4376 & 0,4524 & 0,8085       & 0,008              & 122,7              & 40,90       \\
			  5    & 1,0097   & 0,5482 & 0,5715 & 1,019        & 0,010              & 97,13              & 32,38       \\
			  10   & 1,0215   & 1,109  & 1,206  & 2,127        & 0,022              & 46,01              & 15,34       \\
			  15   & 1,0336   & 1,684  & 1,916  & 3,337        & 0,035              & 28,97              & 9,656       \\
			  20   & 1,0459   & 2,271  & 2,715  & 4,662        & 0,049              & 20,45              & 6,816       \\
			  25   & 1,0671   & 2,897  & 3,619  & 6,121        & 0,065              & 15,34              & 5,112       \\
			  30   & 1,0717   & 3,491  & 4,654  & 7,735        & 0,084              & 11,93              & 3,976       \\
			  35   & 1,0876   & 4,133  & 5,847  & 9,530        & 0,105              & 9,494              & 3,165       \\
			  40   & 1,0984   & 4,771  & 7,239  & 11,54        & 0,130              & 7,668              & 2,556       \\
			  45   & 1,1092   & 5,420  & 8,884  & 13,80        & 0,160              & 6,248              & 2,083       \\
			  50   & 1,1254   & 6,110  & 10,86  & 16,36        & 0,196              & 5,112              & 1,704       \\
			  55   & 1,1419   & 6,820  & 13,27  & 19,30        & 0,239              & 4,183              & 1,394       \\
			  60   & 1,1530   & 7,512  & 16,29  & 22,69        & 0,293              & 3,408              & 1,136       \\
			  65   & 1,1643   & 8,218  & 20,17  & 26,65        & 0,363              & 2,753              & 0,9175      \\
			  70   & 1,1811   & 8,977  & 25,34  & 31,34        & 0,456              & 2,191              & 0,7303      \\ \bottomrule
		\end{tabular}}%
	{}
\end{table}
...
\begin{table}[h]
	\IBGEtab%
	{\caption{Propriedades de sacarose em água, a 20°C. Fração mássica/\%, densidade \(\rho\)/g.cm\(^{-3}\), molaridade \(c\)/\(mol.L^{-1}\), molalidade \(m\)/\(mol.kg^{-1}\), fração molar/\%, proporções molares, e proporção molar de hidroxilas. Densidades obtidas de \citeauthor{Lide2003}. A massa molar da sacarose é 342,2965 g.mol\menosUm }
		\label{tab:conversoes_sacarose}}%
	{
		\centering
		\begin{tabular}{c c c c c c c c}
			\toprule
			\% m/m & \(\rho\) & \(c\)  & \(m\)  & Fração molar & \(\dfrac{n_\mathrm{sacarose}}{n_\mathrm{água}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{sacarose}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{OH}}\) \\ \midrule
			  1    & 1,002    & 0,0293 & 0,0295 & 0,053        & 0,001              & 1881               & 235,1       \\
			  2    & 1,006    & 0,0588 & 0,0596 & 0,107        & 0,001              & 931,0              & 116,4       \\
			  3    & 1,010    & 0,0885 & 0,0904 & 0,163        & 0,002              & 614,3              & 76,79       \\
			  4    & 1,014    & 0,1185 & 0,1217 & 0,219        & 0,002              & 456,0              & 57,00       \\
			  5    & 1,018    & 0,1487 & 0,1538 & 0,276        & 0,003              & 361,0              & 45,13       \\
			  10   & 1,038    & 0,3033 & 0,3246 & 0,581        & 0,006              & 171,0              & 21,38       \\
			  15   & 1,059    & 0,4642 & 0,5155 & 0,920        & 0,009              & 107,7              & 13,46       \\
			  20   & 1,081    & 0,6316 & 0,7304 & 1,299        & 0,013              & 76,00              & 9,500       \\
			  25   & 1,104    & 0,8060 & 0,9738 & 1,724        & 0,018              & 57,00              & 7,125       \\
			  30   & 1,127    & 0,9877 & 1,252  & 2,206        & 0,023              & 44,33              & 5,542       \\
			  35   & 1,151    & 1,177  & 1,573  & 2,756        & 0,028              & 35,29              & 4,411       \\
			  40   & 1,177    & 1,375  & 1,948  & 3,390        & 0,035              & 28,50              & 3,563       \\
			  45   & 1,202    & 1,581  & 2,390  & 4,128        & 0,043              & 23,22              & 2,903       \\
			  50   & 1,230    & 1,796  & 2,921  & 5,000        & 0,053              & 19,00              & 2,375       \\
			  55   & 1,258    & 2,021  & 3,571  & 6,044        & 0,064              & 15,55              & 1,943       \\
			  60   & 1,442    & 2,527  & 4,382  & 7,317        & 0,079              & 12,67              & 1,583       \\ \bottomrule
		\end{tabular}}%
	{}
\end{table}
...
\begin{table}[h]
	\IBGEtab%
	{\caption{Propriedades de DMSO em água, a 25°C. Fração mássica/\%, densidade \(\rho\)/g.cm\(^{-3}\), molaridade \(c\)/\(mol.L^{-1}\), molalidade \(m\)/\(mol.kg^{-1}\), fração molar/\% e proporções molares. Densidades obtidas de \cite{Lebel1962}. A massa molar do DMSO é 78,133 g.mol\menosUm }
		\label{tab:conversoes_dmso}}%
	{
		\centering
		\begin{tabular}{c c c c c c c}
			\toprule
			\% m/m & \(\rho\) & \(c\)  & \(m\)  & Fração molar & \(\dfrac{n_\mathrm{DMSO}}{n_\mathrm{água}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{DMSO}}\)  \\ \midrule
			  5    & 1,0038   & 0,6424 & 0,6736 & 1,199        & 0,012             & 82,40             \\
			  10   & 1,0105   & 1,293  & 1,422  & 2,498        & 0,026             & 39,03             \\
			  15   & 1,0174   & 1,953  & 2,259  & 3,910        & 0,041             & 24,58             \\
			  20   & 1,0242   & 2,622  & 3,200  & 5,450        & 0,058             & 17,35             \\
			  25   & 1,0314   & 3,300  & 4,266  & 7,137        & 0,077             & 13,01             \\
			  30   & 1,0387   & 3,988  & 5,485  & 8,993        & 0,099             & 10,12             \\
			  35   & 1,0461   & 4,686  & 6,892  & 11,04        & 0,124             & 8,054             \\ \bottomrule
		\end{tabular}}%
	{}
\end{table}
...
\begin{table}[h]
	\IBGEtab%
	{\caption{Propriedades de \BD{} em água, a 25°C. Fração mássica/\%, densidade \(\rho\)/g.cm\(^{-3}\), molaridade \(c\)/\(mol.L^{-1}\), molalidade \(m\)/\(mol.kg^{-1}\), fração molar/\%, proporções molares, e proporção molar de hidroxilas. Densidades em função da fração molar obtidas de \citeauthor{Hawrylak1998}. A massa molar do \BD{} é 90,122 g.mol\menosUm. }
		\label{tab:conversoes_13bd}}%
	{
		\centering
		\begin{tabular}{c c c c c c c c}
			\toprule
			\% m/m & \(\rho\) & \(c\)  & \(m\)  & Fração molar & \(\dfrac{n_\mathrm{1,3BD}}{n_\mathrm{água}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{1,3BD}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{OH}}\) \\ \midrule
			4,810  & 0,99866  & 0,5330 & 0,5607 & 0,0100       & 0,0101                                       & 99,00                                        & 49,50                                      \\
			9,220  & 1,00049  & 1,024  & 1,127  & 0,0199       & 0,0203                                       & 49,25                                        & 24,63                                      \\
			11,53  & 1,00135  & 1,282  & 1,447  & 0,0254       & 0,0261                                       & 38,37                                        & 19,19                                      \\
			13,12  & 1,00206  & 1,459  & 1,675  & 0,0293       & 0,0302                                       & 33,13                                        & 16,56                                      \\
			17,25  & 1,00382  & 1,921  & 2,313  & 0,0400       & 0,0417                                       & 24,00                                        & 12,00                                      \\
			20,39  & 1,00525  & 2,274  & 2,842  & 0,0487       & 0,0512                                       & 19,53                                        & 9,767                                      \\
			20,81  & 1,00545  & 2,321  & 2,915  & 0,0499       & 0,0525                                       & 19,04                                        & 9,520                                      \\
			24,62  & 1,00727  & 2,752  & 3,625  & 0,0613       & 0,0653                                       & 15,31                                        & 7,657                                      \\
			30,74  & 1,00993  & 3,445  & 4,925  & 0,0815       & 0,0887                                       & 11,27                                        & 5,635                                      \\ \bottomrule
		\end{tabular}}%
	{}
\end{table}
...
\begin{table}[h]
	\IBGEtab%
	{\caption{Propriedades de ureia em água, a 20°C. Fração mássica, densidade \(\rho\)/\(g.cm^{-3}\), molaridade \(c\)/\(mol.L^{-1}\), molalidade \(m\)/\(mol.kg^{-1}\), fração molar  (\%) e proporções molares. A massa molar da ureia é 60,05526 g.mol\menosUm. Densidades obtidas de \citeauthor{Lide2003}.}
		\label{tab:conversoes_ureia}}%
	{
		\centering
		\begin{tabular}{c c c c c c c}
			\toprule
			\% m/m & \(\rho\) & \(c\)  & \(m\)  & Fração molar & \(\dfrac{n_\mathrm{ureia}}{n_\mathrm{água}}\) & \(\dfrac{n_\mathrm{água}}{n_\mathrm{ureia}}\)  \\ \midrule
			  1    & 1,001    & 0,167 & 0,168 & 0,302        & 0,003          & 330,0          \\
			  2    & 1,003    & 0,334 & 0,340 & 0,608        & 0,006          & 163,4          \\
			  3    & 1,006    & 0,502 & 0,515 & 0,919        & 0,009          & 107,8          \\
			  4    & 1,009    & 0,672 & 0,694 & 1,23         & 0,012          & 80,01          \\
			  5    & 1,011    & 0,842 & 0,876 & 1,55         & 0,016          & 63,34          \\
			  10   & 1,025    & 1,706 & 1,850 & 3,22         & 0,033          & 30,00          \\
			  15   & 1,039    & 2,595 & 2,938 & 5,02         & 0,053          & 18,89          \\
			  20   & 1,053    & 3,506 & 4,163 & 6,97         & 0,075          & 13,34          \\
			  25   & 1,067    & 4,442 & 5,550 & 9,09         & 0,100          & 10,00          \\
			  30   & 1,081    & 5,401 & 7,136 & 11,4         & 0,129          & 7,779          \\
			  35   & 1,093    & 6,367 & 8,965 & 13,9         & 0,162          & 6,191          \\
			  40   & 1,111    & 7,397 & 11,10 & 16,6         & 0,200          & 5,001          \\
			  45   & 1,128    & 8,449 & 13,62 & 19,7         & 0,245          & 4,075          \\ \bottomrule
		\end{tabular}}%
	{}
\end{table}
