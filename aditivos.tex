...
%		TODO
	...
	\chapter{Reologia oscilatória}
		Os aditivos afetam a viscosidade das soluções, como visto na seção \ref{sec:efeito_aditivos_hidrofilicos}. Algumas amostras, nas concentrações de 60 \mM, 100\mM{} e 260\mM{} de NaSal, correspondendo aos máximos e vale de viscosidade em água. Para água, foram analisadas também as concentrações de 35, 72, 189 e 365 \mM.
		
		Foram realizadas análises de reologia oscilatória de varredura de tensão e de varredura de frequência, na região linear. Os resultados foram ajustados aos modelos X, Y, Z, W.