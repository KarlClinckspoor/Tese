...
\begin{apendicesenv}
	...
	\includepdf[scale=.8, pagecommand={}]{./permissoes/diagrama_micelas_gigantes_lequeux_candau.pdf}
	\includepdf[scale=.8, pagecommand={}]{./permissoes/imagem_cates_reptação.pdf}
	\includepdf[scale=.8, pagecommand={}]{./permissoes/imagem_cole-cole_berret.pdf}
	\includepdf[scale=.8, pages={1,2,3}, pagecommand={}]{./permissoes/imagem_goodwin_hughes}
	\includepdf[scale=.8, pagecommand={}]{./permissoes/imagem_Hoffmann_tamanhos_de_MG}
	\includepdf[scale=.8, pages={1,2}, pagecommand={}]{./permissoes/imagem_MG_Danino}
	\includepdf[scale=.8, pages={1,2}, pagecommand={}]{./permissoes/imagem_tamanho_micelas_cecile}
	\includepdf[scale=.8, pages={1,2}, pagecommand={}]{./permissoes/lacowicz_jablonski}
\end{apendicesenv}
