	...
	\begin{table}[h]
		...
		{%
			\begin{tabular}{p{4cm} c c c c}
				...
				NaSal \(\to\) H\textsubscript{2}O & 8          & 0.934   & 23100 \(\pm\) 234 & 60 \(\pm\) 24           \\
				NaSal \(\to\) Sacarose 4\%        & 7          & 0.946   & 25600 \(\pm\) 240 & 64 \(\pm\) 9            \\
				NaSal \(\to\) Sacarose 10\%       & 5          & 0.956   & 26100 \(\pm\) 228 & 44 \(\pm\) 14           \\ \midrule
				MG \(\to\) NaSal                  & 10         & 0.987   & 14540 \(\pm\) 48  & 64 \(\pm\) 9            \\
				MG \(\to\) H\textsubscript{2}O    & 6          & 0.987   & 14190 \(\pm\) 41  & 62 \(\pm\) 34           \\ \bottomrule
			\end{tabular}
		}{}
	\end{table}
