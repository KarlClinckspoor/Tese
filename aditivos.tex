...
%	\end{table}  
	...
	\begin{figure}[h]
		...
		\caption{Tempos de relaxação, em segundos, calculados pelo ajuste dos quatro modelos estudados. As linhas são guias para os olhos, para mostrar a similaridade com o perfil de viscosidade.}
