...
%			\end{figure}
	...
	%	A concentração de ureia na superfície é cerca de 10-30\% menor do que no seio da solução. 
		...
		\begin{figure}[h]
			...
			\caption{Comportamento do modelo de \cmc{} criado, mostrando a correlação entre os valores observados e previstos. A reta mostra onde o modelo prevê os dados exatamente.}
...
%		\end{figure}  
		...
		\begin{figure}[H]
			...
			\caption{Comportamento do modelo de \DHmic{} criado, mostrando a correlação entre os valores observados e previstos. A reta mostra onde o modelo prevê os dados exatamente.}
			\label{fig:pls_dh_pirouette}
		\end{figure}  % todo: colocar o padrão e micelar na notação do Delta H
