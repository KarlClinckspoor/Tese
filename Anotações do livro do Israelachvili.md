...
* Sobre moléculas num meio, suas interações se devem a polarizabilidades de excesso, isso é, propriedades que elas tem de diferente do meio. Caso o soluto fosse igual ao solvente, não haveria interação, elas seriam indistinguíveis. Uma maneira de se tratar isso é considerar a molécula de soluto como sendo uma região de polarizabilidade diferente.
